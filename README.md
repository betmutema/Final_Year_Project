...
| **Channel Efficiency (Optimized vs RS)**  | Channel efficiency for the Optimized NR-U Gap Mode vs. NR-U RS Mode in coexistence. | `![Alt text](output/metric_visualizations/comparative_analysis/coexistence_modes/coexistence_rs_vs_modified_gap_pc.png)`        |
