...
| :-------------------------------------- | :----------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------ |
| **Channel Occupancy (Optimized vs RS)**  | Channel usage for the Optimized NR-U Gap Mode vs. NR-U RS Mode in coexistence.     | ![cot_access_plot](output/metric_visualizations/comparative_analysis/coexistence_modes/coexistence_rs_vs_modified_gap_cot.png)                  |
| **Collision Probability (Optimized vs RS)** | Collision rates for the Optimized NR-U Gap Mode vs. NR-U RS Mode in coexistence. | ![pcol_optimized_plot](output/metric_visualizations/comparative_analysis/coexistence_modes/coexistence_rs_vs_modified_gap_pc.png)        |
| **Channel Efficiency (Optimized vs RS)**  | Channel efficiency for the Optimized NR-U Gap Mode vs. NR-U RS Mode in coexistence. | ![Alt text](output/metric_visualizations/comparative_analysis/coexistence_modes/coexistence_rs_vs_modified_gap_eff.png)        |
